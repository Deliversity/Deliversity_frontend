  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        onValueChange={(itemValue, itemIndex) => this.setState({reportKind: itemValue})}
      ...
      >
        ...
        <Picker.Item label="기타" value="기타" />
            ...
            <View style={styles.cat}>
                <Text>신고 내용</Text>
                <TextInput multiline={true} numberOfLines={7} style={styles.input}
                placeholder="자세한 신고사항을 입력해주세요" 
                onChangeText={(text)=>this.setState({content: text})}></TextInput>
            </View>
            <View style={styles.cat}>
                <Text>주문 아이디</Text>
            ...
            <TouchableOpacity style={styles.butBack} onPress ={
                ...
                <TouchableOpacity style={styles.butEnd} onPress={()=> {this.sendReport()}}>
